...
<head>
    ...
    <title>Salidas auxiliares</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left" id="clientes">Salidas</h2>
                        <a href="create_salidas.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Agregar una salida</a>
                    </div>
                    <div class="container-fluid">
                    <form class="d-flex">
